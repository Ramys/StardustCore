...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_HARD_VALUES,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_EFFECT,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_EFFECT_NON_INDENTIFIERS,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CONSUMPTION,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CONSUMPTIONTEMPLATEID,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CHECKCAST,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CHECKCASTTEMPLATEID,

    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM01,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM02,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM03,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM04,
    CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM05,
