...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    /*
    // Spell Script System
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM, "SELECT * FROM smart_spell_scripting WHERE main_effected_id = ?", CONNECTION_SYNCH);
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CHECKCASTTEMPLATEID, "SELECT * FROM smart_spell_script_check_cast_template WHERE checkcast_template_id = ?", CONNECTION_SYNCH);
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CONSUMPTIONTEMPLATEID, "SELECT * FROM smart_spell_script_spell_consumption WHERE spell_consumption_template_id = ?", CONNECTION_SYNCH);
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_CHECKCAST, "SELECT * FROM smart_spell_scripting WHERE main_effected_id = ?", CONNECTION_SYNCH);
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_EFFECT, "SELECT * FROM smart_spell_script_effects WHERE spell_id = ? AND effect_indentifier = ?", CONNECTION_SYNCH);
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_EFFECT_NON_INDENTIFIERS, "SELECT * FROM smart_spell_script_effects WHERE spell_id = ?", CONNECTION_SYNCH);
    PREPARE_STATEMENT(CHAR_SEL_CUSTOMIZED_ABILITY_SYSTEM_HARD_VALUES, "SELECT * FROM smart_spell_scripting_hard_values WHERE main_effected_id = ?", CONNECTION_SYNCH);
    */
